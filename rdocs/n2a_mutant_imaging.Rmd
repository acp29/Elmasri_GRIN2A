---
title: "GluN1-SEP and Homer1c-tdTomato spine fluorescence when co-expressed with GluN2A mutants" 
output:
...
formula <- sprintf("log(%s) ~ mutation * protein", resp)
lm_model <- lm(formula, data = Data, na.action = "na.fail") 
# With random effects
formula <- sprintf("log(%s) ~ mutation * protein + (1|expt/roi)", resp)
lmer_model <- lme4::lmer(formula, data = Data, REML = FALSE, control = settings, na.action = "na.fail") 
